...
class TestIdentityServiceMethods:
    """AC-1.5.1: IdentityService defines 21 abstract async methods."""
    ...
    def test_has_exactly_22_methods(self):
        """21 methods listed in the AC + get_tenant_users_with_roles = 22 total."""
        abstract_methods = {
            name
