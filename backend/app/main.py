...
from app.routers import accesskeys, attributes, auth, documents, health, protected, rbac_demo, roles, tenants, users
...
app.include_router(rbac_demo.router, prefix="/api")
